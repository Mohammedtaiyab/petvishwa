        ...
        function O(a, b, c) {
            ...
            k.each(b, function (e, f) {
                ...
                d === q || ! c && b[d] !== q || ("o" === d.charAt(0) ? (b[d] || (b[d] =
                    {}), k.extend(!0, b[d], b[e]), O(a[d], b[d], c)) : b[d] = b[e])
            })
        }
        function ma(a) {
        ...
        function Bb(a) {
            if (! u.__browser) {
                ...
                var c = k("<div/>").css({
                        ...
                        width: 100,
                        overflow: "scroll"
                    }).append(k("<div/>").css({width: "100%", height: 10}))).appendTo("body"),
                    d = c.children(),
                    e = d.children();
...
function S(a, b, c, d) {
    ...
    if (l === q) 
        return a.iDrawError != e && null === h && (ca(a, 0, "Requested unknown parameter " + (
        "function" == typeof f.mData ? "{function}" : "'" + f.mData + "'"
    ) + " for row " + b + ", column " + c, 4), a.iDrawError = e),
        h;
    ...
    var p = function (x, r) {
        ...
        t = function (x) {
            if (c === q || c === h) 
                ...
                p(g.mData.sort, x),
                p(g.mData.type, x),
                p(g.mData.filter, x)) : m ? (g._setter || (g._setter = da(g.mData)), g._setter(d, l)) : d[h] = l;
...
function ob(a, b, c, d) {
    ...
    c && a.oFeatures.bSortMulti ? (c = k.inArray(b, T(e, "0")), -1 !== c ? (b = g(e[c], !0), null === b && 1 === e.length && (b = 0), null === b ? e.splice(c, 1) : (e[c][1] = f[b],
    e[c]._idx = b)) : (e.push([b, f[0], 0]), e[e.length - 1]._idx = 0)) : e.length && e[0][0] == b ? (b = g(e[0]), e.length = 1, e[0][1] = f[b],
    e[0]._idx = b) : (e.length = 0, e.push([
        b, f[0]
    ]), e[0]._idx = 0);
    ja(a);
        ...
        var e = [],
            f = function (g, h) {
                if (Array.isArray(g) || g instanceof k) 
                    ...
                    g.nodeName && "tr" === g.nodeName.toLowerCase() ? e.push(g) : (l = k("<tr><td></td></tr>").addClass(h), k("td", l).addClass(h).html(g)[0].colSpan = na(a),
                    e.push(l[0]))
    ...
    Ac = function (a, b, c) {
        ...
        return ub("column", b, function (g) {
            ...
            if (n) 
                switch (n[2]) {
                    case "visIdx":
                    case "visible": h = parseInt(n[1], 10);
                        if (0 > h) {
                ...
                t = function (x, r) {
                    ...
                    for (A = r.length; W < A; W++) {
                        ...
                        if (Array.isArray(M)) {
                            ...
                            B = a.iTabIndex;
                            switch (M) {
                                case "ellipsis": x.append('<span class="ellipsis">&#x2026;</span>');
                                    break;
                                case "first": n = h.sFirst;
                                    0 === e && (B = -1, m += " " + D);
                                    break;
                                ...
                                case "last": n = h.sLast;
                                    ...
                                    break;
                                default: n = a.fnFormatNumber(M + 1),
